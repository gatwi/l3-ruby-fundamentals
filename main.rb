...
def count_students(param, param2, param3, param4)
     param
end

counted = count_students("Hello Ruby Methods", "sickening weather", 142,000)
print counted

# TODO: Method with open params- only difference is there is no brackets
